const firebaseConfig = {
  apiKey: "AIzaSyAsBw3VjKicM-lSPdTxzE-pYjJU4kNQwxA",
  authDomain: "blabz-app-komentar.firebaseapp.com",
  databaseURL: "https://blabz-app-komentar-default-rtdb.firebaseio.com",
  projectId: "blabz-app-komentar",
  storageBucket: "blabz-app-komentar.appspot.com",
  messagingSenderId: "273433027222",
  appId: "1:273433027222:web:75fb67d0f75305179318b7",
  measurementId: "G-6PDT8H739L"
};
            ...
            .on("click", function () {
              ...
              db.ref(
                "comments/" +
                  ...
                  "/replies/" +
                  key
              ).update({ comment: editForm.editBox.value, edited: true });
              Swal.fire("Successfully Edited!", "", "success");
            });
        });
